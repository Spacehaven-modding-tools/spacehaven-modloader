...
- Evaluated PR #70 and folded the useful window/label sizing intent into the broader config UI changes.
- Evaluated PR #72; the `uv`/multi-platform build migration is useful but intentionally left out of this release because it changes packaging scope significantly and belongs in its own PR.
